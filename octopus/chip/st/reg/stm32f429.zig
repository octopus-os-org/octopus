...
pub const devices = struct {
    ...
    pub const STM32F429 = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  Universal synchronous asynchronous receiver transmitter
            pub const UART7 = @as(*volatile types.peripherals.USART6, @ptrFromInt(0x40007800));
            ///  Universal synchronous asynchronous receiver transmitter
            pub const UART8 = @as(*volatile types.peripherals.USART6, @ptrFromInt(0x40007c00));
            ///  Advanced-timers
            ...
            pub const SAI = @as(*volatile types.peripherals.SAI, @ptrFromInt(0x40015800));
            ///  LCD-TFT Controller
            ...
            ///  General-purpose I/Os
            pub const GPIOC = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40020800));
            ///  General-purpose I/Os
            pub const GPIOD = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40020c00));
            ///  General-purpose I/Os
            pub const GPIOE = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40021000));
            ///  General-purpose I/Os
            pub const GPIOF = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40021400));
            ///  General-purpose I/Os
            pub const GPIOG = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40021800));
            ///  General-purpose I/Os
            pub const GPIOH = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40021c00));
            ///  General-purpose I/Os
            pub const GPIOI = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40022000));
            ///  General-purpose I/Os
            pub const GPIOJ = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40022400));
            ///  General-purpose I/Os
            pub const GPIOK = @as(*volatile types.peripherals.GPIOK, @ptrFromInt(0x40022800));
